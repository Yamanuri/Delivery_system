...
#ifndef CUSTOMER_CPP
#define CUSTOMER_CPP
#include "customer.cpp"  // Include customer.cpp only once
#endif

#ifndef DATABASE_CPP
#define DATABASE_CPP
#include "database.cpp"  // Include database.cpp only once
#endif

#ifndef TRANSACTION_CPP
#define TRANSACTION_CPP
#include "transaction.cpp"  // Include transaction.cpp only once
#endif
...
Transaction process(ulli option, Customer customer, Transaction &t)
{
    ...
    case 1:
    {
        Transaction t = customer.select_items(t);
    ...
    case 5:
    {
        ...
        // After completion of Transaction(do not if the transaction is terminated)
        string email = "";
        if (t.total_price > 0)
        {
            ulli i = 0;
